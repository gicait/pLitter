...
def cctv(camera_id, model, dest, img_width, img_height, det_cur, im_cur, slice_width, slice_height, input_size, interval, work_in_night):
    t0 = time.time()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--camera-id', type=int, default=0, help='camera number')
    ...
    parser.add_argument('--img-height', type=int, default=1280, help='image height')
