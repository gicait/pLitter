    ...
    ***************************************************************************** */
    ...
    var ImageClassificationModel = /** @class */ (function () {
        ...
        ImageClassificationModel.prototype.preprocess = function (input, options) {
            ...
            var croppedImg = options.centerCrop ?
                ...
                tfjsCore.image.resizeBilinear(img, IMG_SIZE).expandDims();
    ...
    function loadImageClassification(modelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([tfjsConverter.loadGraphModel(modelUrl), loadDictionary(modelUrl)])];
                    case 1:
    ...
    function centerCropAndResize(img) {
        return tfjsCore.tidy(function () {
            ...
            var boxIndices = [0];
            return tfjsCore.image.cropAndResize(img.toFloat().expandDims(), boxes, boxIndices, IMG_SIZE);
        });
    }
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            img = tfjsCore.tidy(function () { return _this.preprocess(input, options); });
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, tfjsCore.image.nonMaxSuppressionAsync(boxesTensor, boxScores, options.topk, options.iou, options.score)];
                        case 3:
