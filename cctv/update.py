...
if os.path.isfile('camera_config.env'):
    ...
    config = {'frame_height': '1920','xmin':'0','xmax':'1920','ymin':'0','ymax':'1080','iou_thres':'0.5', 'frame_width': '1080', 'images_prefix': "''", 'interval': '30', 'gitpull': 'False', 'send_empty': 'True', 'slice_width': '800', 'slice_height': '752', 'work_in_night': 'False', 'weights': 'pLitterFloat_800x752_to_640x640.pt', 'weights_url': 'https://github.com/gicait/pLitter/releases/download/v0.1/pLitterFloat_800x752_to_640x640.pt'}
